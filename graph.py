...
def plot_data(data, stats):
    ...
    plt.title("Queens Times Over Time (Generated by https://github.com/plettj/queens)")
    ...
    for key, value in stats.items():
        ...
        if "time" in value:
            ...
            detail_text = f"{value['person']} - {value['streak']} day{'s' if value['streak'] > 1 else ''}, Start Day: {value['day']}"
